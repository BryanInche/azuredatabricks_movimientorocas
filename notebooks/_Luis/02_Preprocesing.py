...
spark_datos.write.csv('/mnt/datalakemlopsd4m/raw/proyectopases_raw/fuentedatos_c4m/operacion_marcobre/datos_raw_marcobre_Luis.csv')

# COMMAND ----------

datos.to_csv('/mnt/datalakemlopsd4m/raw/proyectopases_raw/fuentedatos_c4m/operacion_marcobre/datos_raw_marcobre_Luis.csv', index=False)


# COMMAND ----------

# MAGIC %md
# MAGIC ### Analisis de variables

# COMMAND ----------

sns.scatterplot(data=datos, x='coord_x_pases', y='coord_y_pases', hue='has_block_pases', palette='Dark2')


# COMMAND ----------

# MAGIC %md
# MAGIC ## Tratamiento de valores
